...
|------------------|-------------------------------------------|-----------------------|------------------------|-----------------------------|------------------------|
|Конкуренты|
|Незначительный интерес, полномочия отсутсвуют|Наблюдать|Не участвует|Не участвует|Препятствующий|Наблюдение|
|Заказчики|
|Значительный интерес, Незначительные полномочия|Информировать|Стартовый взнос|Контролирует промежуточные результаты, уточняет требования, финансирует|Поддерживающий|Интервью, разработка с представителем заказчика|
|Разработчики|
|Незначительный интерес, умеренные полномочия|Информировать|Сидят-кайфуют|Работают|Интересные интересы и ценные ценности|